...
//We need to check if $llcID is set, this prevents users from directly navigating to this page from the search bar
if (!isset($llcID)) {
    $errorMessage = 'Housing community ID is required.';
    include '../view/error_page.php';
    die();
}
?>
...
<div class="container-lg">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 centerColumnGray">
            <form id="LLCForm" action="../controller/controller.php?action=ProcessAddLLC" method="post"
                enctype="multipart/form-data">
                <h2><span class="spanRed">*</span>Required</h2>
                <!--Hidden inputs for the form-->
                <input type="hidden" name="LLCID" id="LLCID" value="<?php echo htmlspecialchars($llcID); ?>"
                    maxlength="50">
                ...
                <!--Input for the building the LLC is in-->
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <!--Input for the room type the LLC is in-->
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <!--Input for the LLCs name/description-->
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text font13" for="LLCName">Housing Community Name: </label>
                    </div>
                    <input required type="text" name="LLCName" class="form-control" id="LLCName"
                        value="<?php echo htmlspecialchars($llcName); ?>" pattern="[a-zA-Z0-9\(\) ]*" maxlength="50">
                </div>
                <!--Input for the LLCs availability-->
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="font13" style="margin-top: 2px;" class="input-group-text" for="Available">Housing
                            Community Availability: </label>
                    </div>
                ...
                <div class="d-grid border-top border-secondary-subtle">
                    <input style="margin-top: 10px; margin-bottom: 10px;" class="btn btn-outline-secondary"
                        type="submit" value="Add Housing Community Option">
                </div>
            </form>
        </div>
    </div>
