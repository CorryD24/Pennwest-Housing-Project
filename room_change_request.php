<!--This page is the room change request form-->

<?php
$title = "$mode Room Change Request";
//This is the page with the room change request form
require_once '../view/header.php'; //THis requires the header
if (!isset($_SESSION['FirstName'])) {
    $errorMessage = 'Please log in to view the room change request form.';
...
<div class="container-lg">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 centerColumnGray">
            <form id="RoomChangeRequestForm"
                action="../controller/controller.php?action=ProcessAddEditRoomChangeRequest" method="post"
                enctype="multipart/form-data">

                <h2 style="font-size: 22px; text-align: center;"><span class="spanRed">*</span>Required</h2>
                <!--Hidden inputs for the form-->
                <input type="hidden" name="RoomChangeRequestID" id="RoomChangeRequestID"
                    value="<?php echo htmlspecialchars($roomChangeRequestID); ?>" maxlength="50">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="preferredNameInput" class="form-control" id="preferredNameInput"
                        value="<?php echo htmlspecialchars($perferredName); ?>" pattern="[a-zA-Z ]*"
                        maxlength="25"><!--Same pattern as roomates-->
                </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text font13" for="inputLLC01">Choose a Housing Community:</label>
                    </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text font13" for="inputLLC02">Choose a Housing Community:</label>
                    </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="roommateInput01" type="text" class="form-control" id="roommateInput01"
                        ...
                        maxlength="25"><!--This pattern allows all letters and spaces, nothing else-->
                </div>
                ...
                <h5>Reason:</h>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <label class="input-group-text font13" for="Reason"><span class="spanRed">*</span>Reason for
                                Change:</label>
                        </div>
                        <input name="Reason" type="text" class="form-control" id="Reason"
                            value="<?php echo htmlspecialchars($reason) ?>"
                            pattern="[a-zA-Z0-9\(\)\x22\x27\.\!\?\@\#\,\;\:\$ ]*" maxlength="200" required>
                        <!--I allowed many more characters for this regex because the student could use sentances. Acoounts for ( ) . ! ? ; : ' " @ # $. The x22 is " and x27 is ' -->
                    </div>
